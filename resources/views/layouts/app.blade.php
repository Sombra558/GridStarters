...
<nav class="navbar navbar-expand-md navbar-light  shadow-sm fixed-top p-0 d-block d-md-none w-100">
    ...
    <div class="bg-millonario w-100 row justify-content-between m-0  align-items-center">
        ...
        <ul style="width:100%" class="navbar-nav row m-0 flex-row justify-content-between align-content-center col-5 p-0">
        <div id="navbarDropdown" class="nav-link text-white col-5" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
        ...
        <div class="position-absolute" style="bottom:1rem; width:80%;">
                ...
                <li class="nav-item  row mx-2 justify-content-center">
                            <a class="nav-link" target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/gridstarters">
                        ...
                        <li class="nav-item  row mx-2 justify-content-center">
                            ...
                            <a class="nav-link" target="_blank" rel="noopener noreferrer" href="https://www.tiktok.com/@gridstarters?is_copy_url=1&is_from_webapp=v1&lang=es">
