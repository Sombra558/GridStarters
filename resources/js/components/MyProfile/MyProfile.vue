    ...
    <div class="container-fluid">
       ...
       <div class="contenedor-botones-profile">
        ...
        <section v-if="selectedtag==='earrings'">
            ...
            <strong class="d-block">Withdraw</strong>
                <svg  data-toggle="modal" data-target="#exampleModalLong" width="181" height="43" viewBox="0 0 181 43" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <table style="margin-top:25px" class="table table-responsive-sm">
                    <thead>
                    <tr class="table-bg">
                        <th>Date</th>
